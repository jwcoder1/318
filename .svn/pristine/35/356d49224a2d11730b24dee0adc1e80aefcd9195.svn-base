...
@Table(name = "Tempbatv")
@EntityInfo("代墊款登入")
@Synchronize("temp_bat")
@Subselect("select a.* from temp_bat a")
public class Tempbatv extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Tempbatv( String acr_mon, String nbr, String cus_nbr, String seq, String ioseq, String temp_nbr, String temp_desc, String amt, String rec_amt, String status ) {
		super();
	...
	public List<Tempbat> getTempbats() {
