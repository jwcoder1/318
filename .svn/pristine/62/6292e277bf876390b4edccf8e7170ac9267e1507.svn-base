...
import org.esy.bas.service.IStaffService;
 ...
 */
@Controller
@RequestMapping("/api/bas/staff")
public class StaffController {

    public static final String AUTHORITY = "bas_staff";
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Staff o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", staffService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Staff o = staffService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Staff, pageable
	 * @return HttpResult
	 * @date Fri Jun 19 13:45:15 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Staff staff, Pageable pageable) {
		if (staff == null) {
			staff = new Staff();
		}
		return new HttpResult(staffService.query(staff, pageable));
	}
