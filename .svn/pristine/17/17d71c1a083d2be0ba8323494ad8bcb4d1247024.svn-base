...
public class Contacr extends BaseProperties {
	 ...
	 * 
	 */
	public Contacr(String nbr, String seq, String ioseq, Date acr_mon, String cus_nbr, String items_desc, String pi_nbr,
	 ...
	 *            結帳月份
	 */
	public void setAcr_mon(Date Acr_mon) {
		this.acr_mon = Acr_mon;
	}
