...
//	private IAttachmentService attachmentService;  //上傳文件加寫
	...
	@Override
	@Transactional
	public Contyearv save(Contyearv o) throws YesException {
		if (BaseUtil.isNotEmpty(o.getUid())) {

			Contyearv old = dao.getByUid(Contyearv.class, o.getUid());
...
//		return o;
	 ...
	 */
	@Override
	public Contyearv getByUid(String uid) {
		Contyearv o = dao.getByUid(Contyearv.class, uid);
		return o;
	}
	...
	@Override
	@Transactional
	public boolean delete(Contyearv o) throws YesException {
	 ...
	 */
	@Override
	public PageResult<Contyearv> query(Contyearv contyear, Pageable pageable) {
		return (PageResult<Contyearv>) dao.query(Contyearv.class, contyear, pageable);
	}
	...
	public void deletes(String uids) throws YesException {
		...
		for (String uid : uidsArr) {
			...
			Contyearv old = dao.getByUid(Contyearv.class, uid);
			if (BaseUtil.isEmpty(old)) {
				throw new YesException(HttpStatus.INTERNAL_SERVER_ERROR, "记录不存，不可删除!!!");
			}
