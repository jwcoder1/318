...
public class TempbatController {
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Tempbat o, HttpServletRequest request) {
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Tempbat o = tempbatService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Tempbat, pageable
	 * @return HttpResult
	 * @date Fri Jun 19 16:20:53 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Tempbat tempbat, Pageable pageable) {
		if (tempbat == null) {
			tempbat = new Tempbat();
		}
