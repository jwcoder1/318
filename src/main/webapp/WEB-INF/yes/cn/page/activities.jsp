	...
	<div class="activity_bg">
		<div class="main">
			<div class="tab flex wow fadeInUp" data-wow-duration="1s"
				data-wow-delay="0.4s">
				<a class="tab_a flex-1" href="activities.html?status=10">精彩活动</a> <a
					class="tab_a flex-1" href="activities.html?status=20">往期活动</a>
			</div>
			<div class="content">
				<ul class="cleaxfix">

					<c:forEach  items="${exerciselist}" var="exer">
						...
						<li class="wow fadeInUp" data-wow-duration="1s"
							...
							<div class="box">
								<div class="img">
									...
									<img src="${basePath}api/base/attachment/downloadbyAttId?attId=${exer.image}" alt="">
								</div>
								<div class="text">
									<div class="tit">
									<a href="activitydetails.html?uid=${exer.uid}" >${exer.title}</a>
									
									</div>
									<div class="time">时间: ${exer.nbrdate}</div>
									<p>
									...
									<div class="btnBox">
										<a href="activitydetails.html?uid=${exer.uid}" class="ui-btn-more trans_3"><i
											class="icon icon-more trans_3"></i></a>
									</div>
								</div>
							</div>
						</li>
				...
				<div class="page wow fadeInUp" data-wow-duration="1s"
					...
					<c:if test="${page>1}">
						<a class="pre trans_3"
							href="activities.html?status=10&page=${page-1}">上一页</a>
					</c:if>
					<a class="trans_3 cur" href="#">${page}</a>
					<c:if test="${pagecount>page}">
						<a class="next trans_3"
							href="activities.html?status=10&page=${page+1}">下一页</a>
					</c:if>
